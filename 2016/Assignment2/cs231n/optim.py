...
def rmsprop(x, dx, config=None):
  ...
  # config['cache'].                                                          #
  #############################################################################
  cache, decay_rate, learning_rate, epsilon = \
    config['cache'], config['decay_rate'], config['learning_rate'], config['epsilon']
...
def adam(x, dx, config=None):
  ...
  beta1, beta2, epsilon, learning_rate = \
    config['beta1'], config['beta2'], config['epsilon'], config['learning_rate']
